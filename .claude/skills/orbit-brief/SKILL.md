...
2. Write or update `ORBIT-STATUS.md` at the project root with current workspace stats:
   ...
   *Generated by Orbit. Details in .orbit/index.md*
   ```
3. Suggest next step (use the first matching condition):
   - If a theme has 2+ overdue items or stalled decisions: "Run `/orbit-theme [theme-name]` to deep-dive into the most pressing theme."
   - If overdue items across themes: "Run /orbit-decisions to audit stalled decisions."
