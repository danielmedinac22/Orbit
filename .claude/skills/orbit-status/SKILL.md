...
## Step 5 — Update Visible Status

After displaying the status output, write or update `ORBIT-STATUS.md` at the project root with current workspace stats:
...
This file is visible in Finder and editor sidebars, giving the user a quick overview without opening `.orbit/`.

---

## Implementation Notes

- Aside from `ORBIT-STATUS.md`, this skill is read-only. Do NOT write, edit, or modify any other files.
